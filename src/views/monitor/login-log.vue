...
<!--                </el-form-item>-->
<!--                <el-form-item>-->
<!--                    <el-button @click="deleteFileOrDirectory(sels)" icon="el-icon-delete"-->
<!--                               :disabled="this.sels.length === 0">批量-->
<!--                    </el-button>-->
<!--                </el-form-item>-->
<!--            </el-form>-->
<!--            &lt;!&ndash; 表格区域 &ndash;&gt;-->
...
<!--                });-->
<!--                if (res === "confirm") {-->
<!--                    const {data: res} = await batchDelete("system/loginLog/batchDelete/" + ids);-->
<!--                    if (res.success) {-->
...
<!--                const {data: res} = await findLoginLogList(this.queryMap);-->
<!--                if (!res.success) {-->
...
<!--                });-->
<!--                if (res === "confirm") {-->
<!--                    const {data: res} = await deleteLog("system/loginLog/delete/" + id);-->
<!--                    if (res.success) {-->
<!--                        this.$message.success("登入日志删除成功");-->
<!--                        await this.getLoginLogList();-->
<!--                    } else {-->
