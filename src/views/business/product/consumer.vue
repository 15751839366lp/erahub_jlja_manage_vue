...
<!--                });-->
<!--                if (res === "confirm") {-->
<!--                    const {data: res} = await deleteConsumer("/business/consumer/delete/" + id);-->
<!--                    if (res.success) {-->
...
<!--            async edit(id) {-->
<!--                this._getJsonData();-->
<!--                const {data: res} = await edit("/business/consumer/edit/" + id);-->
<!--                if (res.success) {-->
...
<!--                const {data: res} = await findConsumerList(this.queryMap);-->
<!--                if (!res.success) {-->
