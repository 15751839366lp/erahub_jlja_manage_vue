    ...
    export default {
        ...
        setup() {
            ...
            const publishData = (id) => {
                publish("/business/inStock/publish/" + id).then((res) => {
                    if (!res.data.success) {
             ...
             */
            const backData = (id) => {
                back("/business/inStock/back/" + id).then((res) => {
                    if (!res.data.success) {
             ...
             */
            const removeData = (id) => {
                remove("/business/inStock/remove/" + id).then((res) => {
                    if (!res.data.success) {
             ...
             */
            const del = (id) => {
                deleteInStock("/business/inStock/delete/" + id).then((res) => {
                    if (!res.data.success) {
            ...
            const getDetail = (id) => {
                detailId.value = id;
                detail("/business/inStock/detail/" + id + "?pageNum=" + pageNum.value).then((res) => {
                    if (!res.data.success) {
