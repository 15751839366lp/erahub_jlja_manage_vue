                        ...
                        <el-tab-pane label="TOP10城市">
                            <el-table
                                ...
                                <el-table-column
                                        ...
                                        width="180">
                                    <template #default="scope">
                                        <el-tag v-text="scope.row.jwsrNum+'人'" size="mini" type="danger"
                                                effect="plain"></el-tag>
                                    </template>
                                </el-table-column>
                            </el-table>
    ...
    export default {
        ...
        setup() {
            ...
            const buildTable = (val) => {
                ...
                top10.value = data.jwsrTop;

                info.value.push(data1);
                info.value.push(data2);
                info.value.push(data3);
                info.value.push(data4);
                info.value.push(data5);
                info.value.push(data6);
                info.value.push(data7);
                info.value.push(data8);
                loading.value = false;
            }
